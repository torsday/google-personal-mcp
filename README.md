...
| --- | --- | --- |
| **Design** | 22 ADRs in [`docs/adr/`](docs/adr/). Architecture, tool surface, auth, error model, security, testing strategy. | ✅ Complete |
...
The design lives in 22 ADRs. The load-bearing ones:
