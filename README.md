...
| --- | --- | --- |
| **Design** | 21 ADRs in [`docs/adr/`](docs/adr/). Architecture, tool surface, auth, error model, security, testing strategy. | ✅ Complete |
...
The design lives in 21 ADRs. The load-bearing ones:
